...
exports.default = {
    index: function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var users, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, userModel_1.default.find({}).exec()];
                case 1:
                    users = _a.sent();
    ...
    create: function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, userModel_1.default.create(userParams)];
                case 2:
                    _a.sent();
    ...
    redirectView: function (req, res, next) {
        var redirect = res.locals.redirect;
        if (redirect) {
    ...
    edit: function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    delete: function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, userModel_1.default.findByIdAndRemove(userId)];
                case 2:
                    _a.sent();
                    res.locals.redirect = '/users';
                    next();
